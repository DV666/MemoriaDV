    ...
    public class FreezeStatusScript : StatusScriptBase
    {
        public override UInt32 Apply(BattleUnit target, BattleUnit inflicter, params Object[] parameters)
        {
            ...
            if (Target.IsUnderAnyStatus(BattleStatus.EasyKill))
            {
                ...
                {
                    Target.Data.stat.duration_factor[BattleStatusId.Freeze] = (Target.Data.stat.duration_factor[BattleStatusId.Freeze] * (Target_TSVar.Monster.DurationDeadlyStatus) / 100);
