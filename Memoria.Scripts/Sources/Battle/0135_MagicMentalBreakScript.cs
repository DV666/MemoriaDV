...
namespace Memoria.Scripts.Battle
{
    ...
    /// </summary>
    [BattleScript(Id)]
    public sealed class MagicMentalBreakScript : IBattleScript, IEstimateBattleScript
    {
        public const Int32 Id = 0135;

        private readonly BattleCalculator _v;

        public MagicMentalBreakScript(BattleCalculator v)
        {
            _v = v;
        }
